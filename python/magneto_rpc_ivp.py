...
# Initial conditions
u.fill_random('g', seed=42, distribution='normal', scale=1e-2) # Random noise
u['g'] *= x * (Lx - x) # Damp noise at walls
# Analysis

dir_path = f"/home/hlu/thesis/run/mri_ivp/nonlinear/mri_{Rm}_{Co}_{stop_sim_time}"
snapshots_path = dir_path+"/snapshots"
traces_path = dir_path+"/traces"
snapshots = solver.evaluator.add_file_handler(snapshots_path, sim_dt=0.5, max_writes=100)
